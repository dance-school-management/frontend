                  ...
                  <div className="w-full flex items-center justify-between gap-4">
                    ...
                    <div className="w-40 sm:w-auto flex items-center gap-4">
                      <p className="flex flex-wrap">
                        <span className="block">{format(event.startDate, "MMMM d, ")}</span>
                        <span className="block">{format(event.startDate, "HH:mm")}</span>
                      </p>
                      <Repeat />
                      <p className="flex flex-wrap">
                        <span className="block">{format(event.endDate, "MMMM d, ")}</span>
                        <span className="block">{format(event.endDate, "HH:mm")}</span>
                      </p>
                    </div>
                  </div>
                </EventDetailsDialog>
